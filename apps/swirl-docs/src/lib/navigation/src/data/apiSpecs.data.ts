...
export const apiSpecsNavItems: NavItem[] = [
  ...
  },
  {
    ...
    url: "/api-docs/user-api---roles-&-permissions",
    isRoot: true,
    children: [
      {
        title: "List roles",
        url: "/api-docs/user-api---roles-&-permissions#get-all-roles",
        description: "get",
        isRoot: false,
      },
      {
        title: "Get role",
        url: "/api-docs/user-api---roles-&-permissions#get-role",
        description: "get",
        isRoot: false,
      },
    ],
    specName: "users-admin-roles-and-permissions.yml",
  },
  {
    title: "User  - User Group",
    url: "/api-docs/user-api---user-group",
    isRoot: true,
    children: [
      {
        title: "List user groups",
        url: "/api-docs/user-api---user-group#search-user-groups",
        description: "get",
        isRoot: false,
      },
      {
        title: "Get user group",
        url: "/api-docs/user-api---user-group#get-user-group",
        description: "get",
        isRoot: false,
      },
      {
        title: "List user group assignments",
        url: "/api-docs/user-api---user-group#search-user-group-assignments",
        description: "get",
        isRoot: false,
      },
      {
        title: "Get user group assignment",
        url: "/api-docs/user-api---user-group#get-user-group-assignment",
        description: "get",
        isRoot: false,
      },
      {
        title: "List user group assignments grouped by user",
        url: "/api-docs/user-api---user-group#search-user-group-assignments-aggregated-by-user",
        description: "get",
        isRoot: false,
      },
      {
        title: "List user group assignments",
        url: "/api-docs/user-api---user-group#get-user-group-assignments-aggregated-by-user",
        description: "get",
        isRoot: false,
      },
      {
        title: "List assignable users",
        url: "/api-docs/user-api---user-group#get-assignable-users-for-user-group",
        description: "get",
        isRoot: false,
      },
      {
        title: "List configured user group roles",
        url: "/api-docs/user-api---user-group#get-all-user-group-roles",
        description: "get",
        isRoot: false,
      },
      {
        title: "List user group assignments",
        url: "/api-docs/user-api---user-group#search-user-group-assignments-for-single-user",
        description: "get",
        isRoot: false,
      },
      {
        title: "List assignable parent user groups",
        url: "/api-docs/user-api---user-group#search-assignable-parent-user-groups",
        description: "get",
        isRoot: false,
      },
      {
        title: "Create user group",
        url: "/api-docs/user-api---user-group#create-user-group",
        description: "post",
        isRoot: false,
      },
      {
        title: "Archive user group",
        url: "/api-docs/user-api---user-group#archive-user-group",
        description: "post",
        isRoot: false,
      },
      {
        title: "Restore user group",
        url: "/api-docs/user-api---user-group#restore-user-group",
        description: "post",
        isRoot: false,
      },
      {
        title: "Create user group assignment",
        url: "/api-docs/user-api---user-group#assign-user-to-user-group",
        description: "post",
        isRoot: false,
      },
      {
        title: "Assign multiple users to user groups",
        url: "/api-docs/user-api---user-group#assign-users-to-user-group-batch",
        description: "post",
        isRoot: false,
      },
      {
        title: "Update user group",
        url: "/api-docs/user-api---user-group#update-user-group",
        description: "patch",
        isRoot: false,
      },
      {
        title: "Delete user group",
        url: "/api-docs/user-api---user-group#delete-user-group",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Delete user group assignment",
        url: "/api-docs/user-api---user-group#delete-user-group-assignment",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Delete multiple user group assignments",
        url: "/api-docs/user-api---user-group#delete-user-group-assignments-batch",
        description: "delete",
        isRoot: false,
      },
    ],
    specName: "users-admin-user-groups.yml",
  },
  {
    title: "User  - User Admin",
    url: "/api-docs/user-api---user-admin",
    isRoot: true,
    children: [
      {
        title: "List all users",
        url: "/api-docs/user-api---user-admin#search-users",
        description: "get",
        isRoot: false,
      },
      {
        title: "Get user",
        url: "/api-docs/user-api---user-admin#get-user",
        description: "get",
        isRoot: false,
      },
      {
        title: "List assigned organisation roles for user",
        url: "/api-docs/user-api---user-admin#get-user-roles",
        description: "get",
        isRoot: false,
      },
      {
        title: "List linkable identity providers",
        url: "/api-docs/user-api---user-admin#get-linkable-identity-providers",
        description: "get",
        isRoot: false,
      },
      {
        title: "List linked identities for user",
        url: "/api-docs/user-api---user-admin#get-linked-identities",
        description: "get",
        isRoot: false,
      },
      {
        title: "Check OTP configuration",
        url: "/api-docs/user-api---user-admin#has-otp",
        description: "get",
        isRoot: false,
      },
      {
        title: "Check password configuration",
        url: "/api-docs/user-api---user-admin#has-password",
        description: "get",
        isRoot: false,
      },
      {
        title: "Create user",
        url: "/api-docs/user-api---user-admin#create-user",
        description: "post",
        isRoot: false,
      },
      {
        title: "Lock user",
        url: "/api-docs/user-api---user-admin#lock-user",
        description: "post",
        isRoot: false,
      },
      {
        title: "Unlock User",
        url: "/api-docs/user-api---user-admin#unlock-user",
        description: "post",
        isRoot: false,
      },
      {
        title: "Assign organisation role to user",
        url: "/api-docs/user-api---user-admin#assign-role-to-user",
        description: "post",
        isRoot: false,
      },
      {
        title: "Assign organisation roles to users",
        url: "/api-docs/user-api---user-admin#assign-role-to-user-batch",
        description: "post",
        isRoot: false,
      },
      {
        title: "Link identity to user",
        url: "/api-docs/user-api---user-admin#create-linked-identity",
        description: "post",
        isRoot: false,
      },
      {
        title: "Reset password",
        url: "/api-docs/user-api---user-admin#change-password",
        description: "post",
        isRoot: false,
      },
      {
        title: "Send account actions email",
        url: "/api-docs/user-api---user-admin#send-account-actions-email",
        description: "post",
        isRoot: false,
      },
      {
        title: "Send multiple account actions emails",
        url: "/api-docs/user-api---user-admin#send-account-actions-emails-batch",
        description: "post",
        isRoot: false,
      },
      {
        title: "Update user",
        url: "/api-docs/user-api---user-admin#update-user",
        description: "patch",
        isRoot: false,
      },
      {
        title: "Delete user",
        url: "/api-docs/user-api---user-admin#delete-user",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Delete multiple users",
        url: "/api-docs/user-api---user-admin#delete-users-batch",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Remove organisation role assignment from user",
        url: "/api-docs/user-api---user-admin#remove-role-from-user",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Remove multiple role assignments from users",
        url: "/api-docs/user-api---user-admin#remove-role-from-user-batch",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Delete linked identity",
        url: "/api-docs/user-api---user-admin#delete-linked-identity",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Delete OTP",
        url: "/api-docs/user-api---user-admin#delete-otp",
        description: "delete",
        isRoot: false,
      },
      {
        title: "Delete password",
        url: "/api-docs/user-api---user-admin#delete-password",
        description: "delete",
        isRoot: false,
      },
    ],
    specName: "users-admin-users-and-accounts.yml",
  },
  {
    title: "User  - Common",
    url: "/api-docs/user-api---common",
    isRoot: true,
    children: [],
  ...
  {
    title: "User  - User Me",
    url: "/api-docs/user-api---user-me",
    isRoot: true,
    children: [
      {
        title: "Check my password configuration",
        url: "/api-docs/user-api---user-me#do-I-have-a-password",
        description: "get",
        isRoot: false,
      },
      {
        title: "Get my email address",
        url: "/api-docs/user-api---user-me#get-my-email-address",
        description: "get",
        isRoot: false,
      },
      {
        title: "List my on-leave notes",
        url: "/api-docs/user-api---user-me#get-on-leave-notes",
        description: "get",
        isRoot: false,
      },
      {
        title: "Get my on-leave note",
        url: "/api-docs/user-api---user-me#get-on-leave-note",
        description: "get",
        isRoot: false,
      },
      {
        title: "List mentionable users",
        url: "/api-docs/user-api---user-me#get-mentionable-users-for-on-leave",
        description: "get",
        isRoot: false,
      },
      {
        title: "Change my password",
        url: "/api-docs/user-api---user-me#change-my-password",
        description: "post",
        isRoot: false,
      },
      {
        title: "Change my email address",
        url: "/api-docs/user-api---user-me#change-my-account-email",
        description: "post",
        isRoot: false,
      },
      {
        title: "Notify logged in",
        url: "/api-docs/user-api---user-me#logged-in",
        description: "post",
        isRoot: false,
      },
      {
        title: "Create on-leave note",
        url: "/api-docs/user-api---user-me#create-on-leave-note",
        description: "post",
        isRoot: false,
      },
      {
        title: "Update on-leave note",
        url: "/api-docs/user-api---user-me#update-on-leave-note",
        description: "patch",
        isRoot: false,
      },
      {
        title: "Delete on-leave note",
        url: "/api-docs/user-api---user-me#delete-on-leave-note",
        description: "delete",
        isRoot: false,
      },
    ],
