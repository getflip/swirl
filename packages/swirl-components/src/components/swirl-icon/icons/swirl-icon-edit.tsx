    ...
    return (
      ...
      >
        {this.size === 16 && (
          <Fragment>
            <path
              d="M12.7025 6.06027L9.912 3.29863L10.8312 2.37808C11.0829 2.12603 11.3922 2 11.759 2C12.1254 2 12.4344 2.12603 12.6861 2.37808L13.6054 3.29863C13.8571 3.55068 13.9884 3.8549 13.9993 4.21129C14.0103 4.56723 13.8899 4.87123 13.6382 5.12329L12.7025 6.06027ZM2.6566 14C2.47056 14 2.31473 13.9369 2.1891 13.8106C2.06303 13.6848 2 13.5288 2 13.3425V11.4849C2 11.3973 2.01641 11.3124 2.04924 11.2305C2.08207 11.1481 2.13132 11.074 2.19698 11.0082L8.95993 4.23562L11.7505 7.03014L4.98752 13.8027C4.92186 13.8685 4.8481 13.9178 4.76624 13.9507C4.68395 13.9836 4.59903 14 4.51148 14H2.6566Z"
              fill="currentColor"
            />
          </Fragment>
        )}
