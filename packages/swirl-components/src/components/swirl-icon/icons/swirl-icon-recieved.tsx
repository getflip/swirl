  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {(this.size === 20 || this.size === 24) && <Fragment><path d="M1.74999 13.75L4.93933 16.9393C5.52512 17.5251 6.47486 17.5251 7.06065 16.9393L15.75 8.24999C16.1642 7.83578 16.1642 7.1642 15.75 6.74999C15.3358 6.33578 14.6642 6.33578 14.25 6.74999L5.99999 15L3.24999 12.25C2.83578 11.8358 2.1642 11.8358 1.74999 12.25C1.33578 12.6642 1.33578 13.3358 1.74999 13.75Z" fill="currentColor"/><path d="M12 14L10.5 15.5L11.9393 16.9393C12.5251 17.5251 13.4749 17.5251 14.0607 16.9393L22.75 8.24999C23.1642 7.83578 23.1642 7.1642 22.75 6.74999C22.3358 6.33578 21.6642 6.33578 21.25 6.74999L13 15L12 14Z" fill="currentColor"/></Fragment>}
