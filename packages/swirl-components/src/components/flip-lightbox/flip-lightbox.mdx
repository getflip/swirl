...
<Meta title="Components/FlipLightbox" />

# FlipLightbox

The FlipLightbox component is used to present slides of media in a modal
overlay.

- **[Figma Design Specs](https://www.figma.com/file/iRHiAFsHxnzux8gQ9EjlZe/Swirl-Components?node-id=495%3A7144)**
- **[Source Code](https://github.com/flip-corp/swirl/tree/main/packages/swirl-components/src/components/flip-lightbox)**

## Usage

<Canvas withSource="open">
  <Story id="components-fliplightbox--flip-lightbox" />
</Canvas>
