...
<Meta title="Components/SwirlSausageMessage" />

# SwirlSausageMessage

The SwirlSausageMessage component is used to …

- **[Figma Design Specs](#)**
- **[Source Code](https://github.com/flip-corp/swirl/tree/main/packages/swirl-components/src/components/swirl-sausage-message)**

## Usage

<Canvas withSource="open">
  <Story id="components-swirlsausagemessage--swirl-sausage-message" />
</Canvas>
