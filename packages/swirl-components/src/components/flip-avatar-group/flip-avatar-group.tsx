...
export type FlipAvatarGroupBadgePosition = "bottom" | "top";
...
export class FlipAvatarGroup {
  @Prop() badge?: string;
  @Prop() badgePosition?: FlipAvatarGroupBadgePosition = "bottom";
  ...
  render() {
    ...
    const badgeClassName = classnames(
      "avatar-group__badge",
      `avatar-group__badge--position-${this.badgePosition}`
    );
