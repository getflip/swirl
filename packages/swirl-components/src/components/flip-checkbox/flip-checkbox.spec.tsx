...
import { FlipCheckbox } from "./flip-checkbox";

describe("flip-checkbox", () => {
  it("renders all props", async () => {
    const page = await newSpecPage({
      components: [FlipCheckbox],
      html: `<flip-checkbox checked="true" disabled="true" input-id="checkbox" input-name="checkbox" label="Label" value="Value"></flip-checkbox>`,
    });

    expect(page.root).toMatchInlineSnapshot(`
      <flip-checkbox checked="true" disabled="true" input-id="checkbox" input-name="checkbox" label="Label" value="Value">
