...
describe("flip-app-layout", () => {
  it("renders", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <flip-app-layout>
        <mock:shadow-root>
          <section aria-labelledby="app-name" class="app-layout app-layout--mobile-view-body app-layout--transition-style-slides app-layout--transitioning-from-undefined app-layout--transitioning-to-undefined" role="document" tabindex="0">
