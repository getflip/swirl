  ...
  it("renders the input and picker", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <swirl-date-input>
        ...
        <swirl-popover animation="scale-in-y" class="date-input__date-picker-popover" id="popover-swirl-date-input-0" label="Date picker" placement="bottom-end" translucent="">
