  ...
  it("renders the picker", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <swirl-date-picker range="true">
        <mock:shadow-root>
          <wc-datepicker  class="date-picker--fixed-aspect-ratio date-picker--fixed-max-width" elementclassname="date-picker" firstdayofweek="7" locale="en-US" range=""></wc-datepicker>
        </mock:shadow-root>
      </swirl-date-picker>
    `);
  });
