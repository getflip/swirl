...
- **[swirl-toast](?path=/docs/components-swirltoast--docs)** (child) — Toasts are created programmatically via the provider’s API; the provider renders `swirl-toast` instances.
