...
<Meta title="Components/FlipOptionList" />

# FlipOptionList

The FlipOptionList component is used to provide a list of user-selectable items.
...
- **[Source Code](https://github.com/flip-corp/swirl/tree/main/packages/swirl-components/src/components/flip-option-list)**

## Usage

<Canvas withSource="open">
  <Story id="components-flipoptionlist--flip-option-list" />
</Canvas>
...
| Key                                | Action                              |
| ---------------------------------- | ----------------------------------- |
| <kbd>SPACE</kbd>                   | Select/unselect the focused option. |
