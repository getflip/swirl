...
import * as Stories from "./swirl-lightbox.stories";
...
<Canvas of={Stories.SwirlLightbox}></Canvas>

<Source
  code={`<swirl-lightbox label="Lightbox">
    <swirl-file-viewer
        description="Another cute dog in a blanket."
        file="/sample-2.jpg"
        thumbnail-url="/sample-2.jpg"
        type="image/jpeg"
        file-name="Cute dog"
    ></swirl-file-viewer>
    <swirl-file-viewer
        description="Cute dog in a blanket."
        file="/sample.jpg"
        thumbnail-url="/sample.jpg"
        type="image/jpeg"
    >
    ...
    <swirl-button
        hide-label
        icon="<swirl-icon-crop></swirl-icon-crop>"
        label="Crop image"
        pill
        slot="toolbar"
        variant="on-image"
...
<Controls of={Stories.SwirlLightbox} />

## Related components

- **[swirl-file-viewer](?path=/docs/components-swirlfileviewer--docs)** (child)
  — Slide content; use `swirl-file-viewer` elements as direct children in the
  default slot of `swirl-lightbox`.
