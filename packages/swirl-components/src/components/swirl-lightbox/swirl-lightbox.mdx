...
<Canvas of={Stories.SwirlLightbox} sourceState="shown"></Canvas>

<Controls of={Stories.SwirlLightbox} />

## Related components

- **[swirl-file-viewer](?path=/docs/components-swirlfileviewer--docs)** (child) — Slide content; use `swirl-file-viewer` elements as direct children in the default slot of `swirl-lightbox`.
