...
Releases of our NPM packages are automatically carried out with each merge into
the `main` branch. The versioning happens on the basis of the changesets. This
prevents sluggish release cycles and makes it possible to integrate changes to
the library at short notice.
