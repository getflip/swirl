...
- The changes meet the
  [🤖 testing requirements](?path=/docs/requirements-testing--docs).
  - New features are tested.
  - In case of bug fixes, regression tests have been added.
  - All tests are 🟢.
- The changes meet the
  [🧏‍♀️ accessibility requirements](?path=/docs/requirements-accessibility--docs).
...
- The changes use our
  [🌈 theming concept](?path=/docs/requirements-theming--docs).
...
- The changes meet our
  [🌍 internationalization requirements](?path=/docs/requirements-internationalization--docs).
