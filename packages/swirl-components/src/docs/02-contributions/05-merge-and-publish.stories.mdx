...
<Meta title="Contributions/Merge and Publish" />
...
- The submitted code is organized and formatted according to our
  [💅 Style Guide](/?path=/story/requirements-style-guide--styleguide).
  - The code is formatted with Prettier.
  - There are no linting errors.
- The changes meet the
  [🤖 testing requirements](/?path=/story/requirements-testing--testing).
  - New features are tested.
  - In case of bug fixes, regression tests have been added.
  - All tests are 🟢.
- The changes meet the
  [🧏‍♀️ accessibility requirements](/?path=/story/requirements-accessibility--accessibility).
...
- The changes use our
  [🌈 theming concept](/?path=/story/requirements-theming--theming).
...
- The changes meet our
  [🌍 internationalization requirements](/?path=/story/requirements-internationalization--internationalization).
...
- The changes work in all supported browsers and viewports. See
  [📱 Responsive Design](/?path=/story/requirements-responsive-design--responsivedesign)
