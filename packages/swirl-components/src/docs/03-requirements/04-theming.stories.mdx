...
[Design Tokens section](?path=/docs/design-tokens-background-colors--page), or
...
[Theme Provider](?path=/docs/components-flipthemeprovider--flip-theme-provider).
...
Have a look at the
[FlipThemeProvider component](?path=/docs/components-flipthemeprovider--flip-theme-provider)
