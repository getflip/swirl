 ...
 * @example {background: '#fff'} // --s-background: #fff;
 */
...
/**
 * Mapping of Swirl color schemes to operating system color schemes.
 *
...
/**
 * Swirl color schemes and their associated color tokens.
 */
