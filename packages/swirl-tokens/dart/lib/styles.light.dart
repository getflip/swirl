...
<<<<<<< HEAD
// Generated on Tue, 13 Jun 2023 07:57:16 GMT
=======
// Generated on Wed, 07 Jun 2023 12:55:03 GMT
>>>>>>> main
...
class SwirlDesignTokensLight {
  SwirlDesignTokensLight._();
    ...
    static const actionNeutralDefault = Color(0xFFF2F3F5); /* Used for containers that are low emphasis action elements. */
    static const actionNeutralDisabled = Color(0xFFF2F3F5); /* Used if a component with “Action Neutral/Default” has a disabled state. */
    static const actionNeutralHovered = Color(0xFFE8E9EB); /* Used if a component with “Action Neutral/Default” has a hovered state. */
    static const actionNeutralPressed = Color(0xFFDDDEE0); /* Used if a component with “Action Neutral/Default” has a pressed state. */
    static const actionPrimaryDefault = Color(0xFF15192F); /* Used for containers that are high emphasis action elements. */
    static const actionPrimaryDisabled = Color(0xFFF2F3F5); /* Used if a component with “Action Primary/Default” has a disabled state. */
    static const actionPrimaryHovered = Color(0xFF383C4E); /* Used if a component with “Action Primary/Default” has a hovered state. */
    static const actionPrimaryPressed = Color(0xFF5B5E6D); /* Used if a component with “Action Primary/Default” has a pressed state. */
    ...
    static const backgroundHovered = Color(0xFFF2F3F5); /* Used if a component with “Background/Default” has a hovered state. */
    static const backgroundPressed = Color(0xFFE8E9EB); /* Used if a component with “Background/Default” has a pressed state. */
    static const borderCritical = Color(0xFFD50636); /* Usally used as an border on critical components. */
    static const borderDefault = Color(0xFFE8E9EB); /* Usually used for low emphasis borders and espacially divider elements. */
    static const borderHighlight = Color(0xFF003DAF); /* Used as border color on containers that need to be highlighted (e.g. form fields). */
    ...
    static const borderStrong = Color(0xFFCCCDD1); /* Usually used for high emphasis borders. */
    ...
    static const iconDefault = Color(0xFF6D6E72); /* Used for low emphasis icons. */
    static const iconDisabled = Color(0xFFCCCDD1); /* Used if a icon element is disabled. */
    ...
    static const iconOnSurfaceHighlight = Color(0xFFFFFFFF); /* Used as icon color on containers with highlight color. */
    static const iconStrong = Color(0xFF191A1C); /* Used for high emphasis icons. */
    ...
    static const interactiveNeutralDefault = Color(0xFF6D6E72); /* Used for icon and text that are low emphasis interactive elements. */
    static const interactiveNeutralDisabled = Color(0xFFCCCDD1); /* Used if a component with “Interactive Neutral/Default” has a disabled state. */
    static const interactiveNeutralHovered = Color(0xFFA1A2A5); /* Used if a component with “Interactive Neutral/Default” has a hovered state. */
    static const interactiveNeutralPressed = Color(0xFFA1A2A5); /* Used if a component with “Interactive Neutral/Default” has a pressed state. */
    ...
    static const interactivePrimaryHovered = Color(0xFF265ABB); /* Used if a component with “Interactive Primary/Default” has a hovered state. */
    ...
    static const onSurfaceHighlightDefault = Color(0xFF2647FF); /* Used to place containers on “Surface Highlight/Default”. */
    ...
    static const surfaceHighlightDefault = Color(0xFF0026FF); /* Usually used for containers that need to be highlighted. */
    static const surfaceHighlightHovered = Color(0xFF2647FF); /* Used if a component with “Surface Highlight/Default” has a hovered state. */
    static const surfaceHighlightPressed = Color(0xFF4D67FF); /* Used if a component with “Surface Highlight/Default” has a pressed state. */
    static const surfaceHovered = Color(0xFFF2F3F5); /* Used if a component with “Surface/Default” has a hovered state. */
    ...
    static const surfaceNeutralDefault = Color(0xFF3A3B3D); /* Used as a background for neutral surfaces. */
    static const surfaceNeutralSubdued = Color(0xFFF2F3F5); /* Used for low prio neutral background. */
    ...
    static const surfaceOverlayHovered = Color(0xFFF2F3F5); /* Used if a component with “Surface Overlay/Default” has a hovered state. */
    static const surfaceOverlayPressed = Color(0xFFE8E9EB); /* Used if a component with “Surface Overlay/Default” has a pressed state. */
    static const surfacePressed = Color(0xFFE8E9EB); /* Used if a component with “Surface/Default” has a pressed state. */
    static const surfaceRaisedDefault = Color(0xFFF2F3F5); /* Usually used for elements that need contrast on surfaces or background */
    static const surfaceRaisedHovered = Color(0xFFE8E9EB); /* Used if a component with “On Surface/Default” has a hovered state. */
    static const surfaceRaisedPressed = Color(0xFFDDDEE0); /* Used if a component with “On Surface/Default” has a pressed state. */
    ...
    static const textDefault = Color(0xFF191A1C); /* Used for high emphasis text. */
    static const textDisabled = Color(0xFFCCCDD1); /* Used if a text element is disabled. */
    ...
    static const textOnSurfaceHighlight = Color(0xFFFFFFFF); /* Used as text color on containers with highlight color. */
    static const textSubdued = Color(0xFF6D6E72); /* Used for low emphasis text. */
