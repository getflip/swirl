...
<<<<<<< HEAD
// Generated on Tue, 29 Aug 2023 10:01:25 GMT
=======
// Generated on Mon, 09 Oct 2023 10:13:22 GMT
>>>>>>> main
...
class SwirlDesignTokensDark {
  SwirlDesignTokensDark._();
    ...
    static const actionNeutralPressed = Color(0xFF363636); /* Used if a component with “Action Neutral/Default” has a pressed state. */
    static const actionPrimaryDefault = Color(0xFF568FDE); /* Used for containers that are high emphasis action elements. */
    static const actionPrimaryDisabled = Color(0xFF262626); /* Used if a component with “Action Primary/Default” has a disabled state. */
    ...
    static const backgroundDefault = Color(0xFF171717); /* Usually used for the page background and elements that should not elevate from the background. */
    static const backgroundHovered = Color(0xFF1C1C1C); /* Used if a component with “Background/Default” has a hovered state. */
    static const backgroundPressed = Color(0xFF262626); /* Used if a component with “Background/Default” has a pressed state. */
    ...
    static const decorativeBananaSurface = Color(0xFFAF911B); /* Used as a decorative color. */
    static const decorativeBananaSurfaceSubdued = Color(0xFF2C271D); /* Used as a decorative color. */
    static const decorativeBananaText = Color(0xFFAF911B); /* Used as a decorative color. */
    static const decorativeBlueberrySurface = Color(0xFF568FDE); /* Used as a decorative color. */
    static const decorativeBlueberrySurfaceSubdued = Color(0xFF1E2936); /* Used as a decorative color. */
    static const decorativeBlueberryText = Color(0xFF568FDE); /* Used as a decorative color. */
    static const decorativeChilliSurface = Color(0xFFDA6D6D); /* Used as a decorative color. */
    static const decorativeChilliSurfaceSubdued = Color(0xFF382221); /* Used as a decorative color. */
    static const decorativeChilliText = Color(0xFFDA6D6D); /* Used as a decorative color. */
    static const decorativeGrapeSurface = Color(0xFFC26BE9); /* Used as a decorative color. */
    static const decorativeGrapeSurfaceSubdued = Color(0xFF2F2438); /* Used as a decorative color. */
    static const decorativeGrapeText = Color(0xFFC26BE9); /* Used as a decorative color. */
    static const decorativeKiwiSurface = Color(0xFF59A469); /* Used as a decorative color. */
    static const decorativeKiwiSurfaceSubdued = Color(0xFF222B22); /* Used as a decorative color. */
    static const decorativeKiwiText = Color(0xFF59A469); /* Used as a decorative color. */
    static const decorativePumpkinSurface = Color(0xFFD48031); /* Used as a decorative color. */
    static const decorativePumpkinSurfaceSubdued = Color(0xFF33251A); /* Used as a decorative color. */
    static const decorativePumpkinText = Color(0xFFD48031); /* Used as a decorative color. */
    static const decorativeRadishSurface = Color(0xFFDD69BD); /* Used as a decorative color. */
    static const decorativeRadishSurfaceSubdued = Color(0xFF32232D); /* Used as a decorative color. */
    static const decorativeRadishText = Color(0xFFDD69BD); /* Used as a decorative color. */
    static const focusDefault = Color(0xFF568FDE);
    ...
    static const iconDefault = Color(0xFF989898); /* Used for low emphasis icons. */
    ...
    static const interactivePrimaryDefault = Color(0xFF568FDE); /* Used for icon and text that are high emphasis interactive elements. */
    static const interactivePrimaryDisabled = Color(0xFF424242); /* Used if a component with “Interactive Primary/Default” has a disabled state. */
    static const interactivePrimaryHovered = Color(0xFF79A4DF); /* Used if a component with “Interactive Primary/Default” has a hovered state. */
    static const interactivePrimaryPressed = Color(0xFF96B5E0); /* Used if a component with “Interactive Primary/Default” has a pressed state. */
    ...
    static const surfaceDefault = Color(0xFF1C1C1C); /* Usually used for containers that need to be elevated. */
    ...
    static const surfaceOverlayPressed = Color(0xFF363636); /* Used if a component with “Surface Overlay/Default” has a pressed state. */
    static const surfacePressed = Color(0xFF2E2E2E); /* Used if a component with “Surface/Default” has a pressed state. */
    static const surfaceRaisedDefault = Color(0xFF2E2E2E); /* Usually used for elements that need contrast on surfaces or background */
    static const surfaceRaisedHovered = Color(0xFF363636); /* Used if a component with “On Surface/Default” has a hovered state. */
    static const surfaceRaisedPressed = Color(0xFF424242); /* Used if a component with “On Surface/Default” has a pressed state. */
    ...
    static const surfaceSunkenHovered = Color(0xFF171717);
    static const surfaceSunkenPressed = Color(0xFF1C1C1C);
